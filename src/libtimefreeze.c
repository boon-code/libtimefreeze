...
static int (*real__gettimeofday)(struct timeval *, void *) = NULL;
static time_t (*real__time)(time_t *tloc) = NULL;
...
static void lib_init(void)
{
	...
	real__time = dlsym(RTLD_NEXT, "time");
	ABORT_LOAD_FAILED(real__time);
